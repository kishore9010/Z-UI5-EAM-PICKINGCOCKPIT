		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#pickingcockpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pickingcockpit-display": {
								"semanticObject": "pickingcockpit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pickingcockpit",
									"url": sap.ui.require.toUrl("pickingcockpit")
								}
							}
						}
					}
